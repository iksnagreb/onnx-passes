...
# Inverse property: x - x = 0, two identical inputs (dynamic of constant) are
...
# Inverse property: x / x = 1, two identical inputs (dynamic of constant) are
...
# ==============================================================================
# BitwiseOr and BitwiseAnd are constrained to (signed) integer input and output
# tensors of the same type. These behave as commutative groups, i.e., the
# following properties are exploited to simplify expressions, and to group,
# propagate, fuse and eventually eliminate constants:
#
# Associativity, the existence of an inverse element, the existence of an
# identity element, and commutativity.
# ==============================================================================
# TODO: Implement these properties...

# ==============================================================================
# BitwiseOr and BitwiseAnd are linked via distributivity and some other
# properties, such as De Morgan's laws...
# ==============================================================================
# TODO: Implement these properties...

# ==============================================================================
# Logical Or and And are constrained to boolean inputs and output tensor of the
# same type. These behave as commutative groups, i.e., the following properties
# are exploited to simplify expressions, and to group,  propagate, fuse and
# eventually eliminate constants:
#
# Associativity, the existence of an inverse element, the existence of an
# identity element, and commutativity.
# ==============================================================================
...
# ==============================================================================
# Logical Or and And are linked via distributivity and some other properties,
